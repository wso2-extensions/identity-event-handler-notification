...
/**
 * Client exception for NotificationSenderManagement.
 */
public class NotificationSenderManagementClientException extends NotificationSenderManagementException {

    public NotificationSenderManagementClientException(ErrorMessage errorMessage, String descriptionData, Throwable e) {

        super(errorMessage, descriptionData, e);
    }

    public NotificationSenderManagementClientException(ErrorMessage errorMessage, String descriptionData) {

        super(errorMessage, descriptionData);
    }

    public NotificationSenderManagementClientException(ErrorMessage errorMessage) {
