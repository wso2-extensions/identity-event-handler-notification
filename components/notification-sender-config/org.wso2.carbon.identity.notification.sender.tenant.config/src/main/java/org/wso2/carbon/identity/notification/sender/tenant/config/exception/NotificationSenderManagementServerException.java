...
/**
 * Server exception for NotificationSenderManagement.
 */
public class NotificationSenderManagementServerException extends NotificationSenderManagementException {

    public NotificationSenderManagementServerException(ErrorMessage errorMessage, String descriptionData, Throwable e) {

        super(errorMessage, descriptionData, e);
    }

    public NotificationSenderManagementServerException(ErrorMessage errorMessage, String descriptionData) {
