...
package org.wso2.carbon.identity.event.handler.notification.test.osgi.util;
 ...
 */
public class IdentityNotificationHandlerOSGiTestUtils {
    ...
    public static List<Option> getDefaultSecurityPAXOptions() {
        ...
        defaultOptionList.add(mavenBundle()
                ...
                .versionAsInProject());
        defaultOptionList.add(mavenBundle()
                .groupId("org.wso2.carbon.identity.event.handler.notification")
                .artifactId("org.wso2.carbon.identity.event.handler.notification")
                .versionAsInProject());
        defaultOptionList.add(mavenBundle()
        ...
        defaultOptionList.add(mavenBundle()
                .groupId("org.wso2.carbon.identity.event.handler.notification")
                .artifactId("org.wso2.carbon.email.mgt")
                .versionAsInProject());
        defaultOptionList.add(mavenBundle()
                .groupId("org.wso2.carbon.identity.mgt")
                ...
                .versionAsInProject());
        defaultOptionList.add(mavenBundle()
                .groupId("org.wso2.orbit.javax.mail")
                .artifactId("mail")
                .versionAsInProject());
        defaultOptionList.add(mavenBundle()
